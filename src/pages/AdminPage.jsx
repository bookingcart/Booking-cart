          ...
          <header className="bg-white border-b border-slate-200 sticky top-0 z-40">
              <div className="container mx-auto px-6 h-20 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-4 min-w-0">
                      <a href="/" className="text-2xl font-extrabold text-slate-900 tracking-tight shrink-0"><img
                              src="/images/logo.png" alt="BookingCart" className="h-10 rounded-xl" /></a>
                      <span
                          className="text-xs font-bold bg-green-100 text-green-700 px-3 py-1 rounded-full uppercase tracking-wider shrink-0">Admin</span>
                  </div>
